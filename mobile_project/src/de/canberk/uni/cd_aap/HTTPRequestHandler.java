...
public class HTTPRequestHandler {
	...
	/**
	 * 
	 * @param	params	The parameters added to the end of the URI.
	...
	/**
	 * 
	 * @param	params	A list of name value pairs which will be send as parameters.
	 * @return			The response of the HTTP request converted into a String.
	 * @author	Canberk Demirkan
	 * 
	 **/
	...
	/**
	 * 
	 * @param	is		An InputStream which will be converted to String.
